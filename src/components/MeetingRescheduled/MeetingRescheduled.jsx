...
import classes from "./MeetingRescheduled.module.css";
import greenTick from "../MeetingScheduled/Assets/greenTick.svg";
    ...
    <React.Fragment>
      ...
      {screenWidth < 767 && (
        ...
        >
          ...
          <div
            className={`${classes.meetingDetailsFlexboxMob} d-flex flex-column align-items-center my-3`}
          >
          ...
          <div className="my-3 d-flex flex-column align-items-center">
            <Button className="my-2" id={classes.addToCalendarMob}>
              Add to Calendar
            </Button>
            <Link to="/dashboard">
              <Button className="my-2" id={classes.goToDashboardMob}>
                Go to Dashboard
              </Button>
            </Link>
          </div>
...
export default MeetingRescheduled;
